...
<? // hier naam en datum
	...
	echo $titelmetdatum;
?>
 	<p><a href="wedstrschema.php?toernooiid=<? echo $toernooiid ?>">maximaal wedstrijdschema</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="wedstrschemainvul_teamnamen.php?toernooiid=<? echo $toernooiid ?>">wedstrijdschema met teamnamen</a></p>
<?
 //hier het wedstrijdschema
	$wedstrijdschema = $toernooi->toonWedstrijdschema($toernooiid,$achtergrond,0);
