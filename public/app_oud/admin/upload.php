...
// if everything is ok, try to upload file
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
        ...
        //in tabel toernooien veld 'achtergrond' updaten met achtergrond naam
        $achtergrondnaam = basename($_FILES["fileToUpload"]["name"]);
        //echo "<br>".$achtergrondnaam;
		...
		$stmtprep->execute([$achtergrondnaam,$toernooiid]);
    } else {
