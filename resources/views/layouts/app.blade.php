...
<head>
    ...
    <title>{{ config('app.name', 'De Toernooiplanner') }}</title>
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}"><img src="{{ asset('/img/logo_plaatje_dtp.jpg') }}" alt="" height="60px"></a>
{{--                <a class="navbar-brand" href="{{ url('/') }}">
                    {{ config('app.name', 'De Toernooiplanner') }}
                </a>--}}
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <!-- Left Side Of Navbar -->
                    <p class="navbar-nav m-auto">
                        <img src="{{ asset('/img/logo_tekst_dtp.jpg') }}" alt="" style="padding-left: 95px;">
                    </p>
