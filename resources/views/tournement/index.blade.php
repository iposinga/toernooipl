                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                <div class="accordion-body" style="padding: 10px 8px; background-color: white">
                                    ...
                                    <div class="d-grid col-4 mx-auto">
                                        <a href="{{ route('poule.index', $poule->id) }}" target="_blank" class="btn btn-sm" style="background-color: #9ec4d5;">
...
@section('scripts')
         <script>
            ...
            function updateUitslag()
            {
                ...
                let url = "{{ route('updategamedata', ':id') }}";
            ...
            {
               let url = "{{ route('editpouledata', ':id') }}";
                url = url.replace(':id', id);
                $.ajax({
                    url: url,
                    data: {
            ...
            {
                let url = "{{ route('deletetournement', ':id') }}";
                url = url.replace(':id', tournementid);
            ...
            {
                let url = "{{ route('showpouledata', ':id') }}";
                url = url.replace(':id', id);
                $.ajax({
                    url: url,
                    data: {
